...
def create_professor_form():
    return '''
        ...
        <form action="/assign_assignment" methods='POST'>
        ...
        <input type="text" id="assignment_description" name="assignment_description" required><br>
...
def assign_assignment():
    if request.method == 'POST':
        ...
        return redirect(url_for('professor.assign_assignment_form'))
...
def assign_assignment_form():
    if request.method == 'POST':
        ...
        return redirect(url_for('professor.assignment_success'))
    else:
        return """
            <!DOCTYPE html>
    <html lang="en">
